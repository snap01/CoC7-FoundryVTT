...
export class ActionConfig extends FormApplication {
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            ...
            template: "systems/CoC7/lib/monks-active-tiles/templates/action-config.html",
            width: 550,
            height: 'auto',
            dragDrop: [
    ...
    getData(options) {
        ...
        return mergeObject(super.getData(options), {
            ...
            poweredBy: !game.modules.get('monks-active-tiles')?.active
        });
    }
    ...
    static async addTag(event) {
        ...
        const html = await renderTemplate(`systems/CoC7/lib/monks-active-tiles/templates/tagger-dialog.html`, {
            data: entity,
            scenes: scenes,
            poweredBy: !game.modules.get('monks-active-tiles')?.active
        });
    ...
    async editEntityId(event) {
        ...
        const html = await renderTemplate(`systems/CoC7/lib/monks-active-tiles/templates/entity-dialog.html`, {
            data: entity,
            poweredBy: !game.modules.get('monks-active-tiles')?.active
        });
    ...
    async editLocationId(event) {
        ...
        const html = await renderTemplate(`systems/CoC7/lib/monks-active-tiles/templates/location-dialog.html`, {
            action: data.action,
            data: location,
            sceneList: sceneList,
            poweredBy: !game.modules.get('monks-active-tiles')?.active
